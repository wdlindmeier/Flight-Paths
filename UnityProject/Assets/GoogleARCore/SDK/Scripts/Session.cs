...
namespace GoogleARCore
{
    ...
    public static class Session
    {
        ...
        /// </summary>
        /// <param name="position">The position to anchor.</position>
        /// <param name="rotation">The rotation to anchor.</position>
        ...
        /// </summary>
        /// <param name="ray">The starting point and direction of the ray.</position>
        /// <param name="filter">A filter bitmask where each <c>TrackableHitFlag</c> which is set represents a category
        /// of raycast hits the method call should consider valid.</position>
        /// <param name="hitResult">A <c>TrackableHit</c> that will be set if the raycast is successful.</position>
