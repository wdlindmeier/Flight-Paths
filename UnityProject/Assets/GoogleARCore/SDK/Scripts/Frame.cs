...
namespace GoogleARCore
{
    ...
    public class Frame
    {
        ...
        /// <summary>
        /// Gets all <c>TrackPlane</c> objects that have been detected in the session.
        /// </summary>
        /// <param name="planes">A list of <b>TrackedPlane</c> to be filled by the method call.</position>
