...
namespace GoogleARCore
{
    ...
    public class TrackedPlane
    {
        ...
        public TrackedPlane(ApiPlaneData apiPlaneData, out Action<ApiPlaneData, TrackedPlane> updatePlane)
        {
            _UpdatePlaneIfNeeded(apiPlaneData, null);
        ...
        /// the plane.
        /// </summary>
        /// <param name="boundaryPolygonPoints">A list of <b>Vector3</c> to be filled by the method call.</param>
        ...
        /// </summary>
        /// <param name="apiPlaneData">ApiPlaneData source.</param>
        private void _UpdatePlaneIfNeeded(ApiPlaneData apiPlaneData, TrackedPlane subsumedBy)
        {
            ...
            else if (m_initialized && apiPlaneData.timestamp == m_apiPlaneData.timestamp)
            {
                return;
            }
