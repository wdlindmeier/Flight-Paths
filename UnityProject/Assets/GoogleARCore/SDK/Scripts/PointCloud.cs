...
namespace GoogleARCore
{
    ...
    /// <summary>
    /// A point cloud is set of observed 3D points and associated confidence
    /// values that correspond to the feature points tracked by ARCore. Defined
    /// relative to @link getPose.
    /// </summary>
    public struct PointCloud
    {
        ...
        /// <summary>
        /// Construtor for a new PointCloud wrapping <c>rawPointCloud</c>.
        /// </summary>
        ...
        /// points in this cloud are defined relative to this pose. @link
        /// GetPoint can be used to access each point in the cloud in Unity
