...
namespace GoogleARCore
{
    ...
    {
        /// <summary>
        /// The location where the raycast hit the object in Unity world coodinates.
        /// </summary>
        ...
        /// <summary>
        /// A bitmask where set <c>TrackableHitFlag<c> flags correspond to categories of objects the hit belongs to.
        /// </summary>
        public TrackableHitFlag Flags { get; private set; }

        /// <summary>
        /// Gets the <c>TrackedPlane</c> intersected by the Raycast if one exists, otherwise gets <c>null</c>.
        /// </summary>
